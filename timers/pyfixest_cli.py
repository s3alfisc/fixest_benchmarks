...
def main():
    ...
    if args.method == "feols":
        _ = pf.feols(args.formula, data, demeaner_backend="rust")
    elif args.method == "fepois":
        _ = pf.fepois(args.formula, data, demeaner_backend="rust")
    elif args.method == "feglm_logit":
        _ = pf.feglm(args.formula, data, "logit", demeaner_backend="rust")
